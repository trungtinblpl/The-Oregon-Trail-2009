...
public class ScenesManager : MonoBehaviour
{
    ...
    [SerializeField] private RectTransform cow; // Kéo Cow vô đây trong Inspector
    ...
    public void NewGameScene()
    {
        ...
        StartCoroutine(FakeLoading(1, 3f));
    }

    private IEnumerator FakeLoading(int sceneIndex, float duration)
    {
        float timer = 0f;
